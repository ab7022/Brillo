...
const TechStack = ({ resume }) => {
  return (
    <div className="col-span-1 row-span-1 rounded-2xl p-8 flex flex-col space-y-2 bg-neutral-100 bg-opacity-75 hover:bg-neutral-50 hover:bg-opacity-90">
      <div className="text-xl lg:text-2xl text-teal-900 font-normal flex justify-start">
        Resume
      </div>
