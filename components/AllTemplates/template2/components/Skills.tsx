...
import SkillCard from "@/components/AllTemplates/template2/components/skills/SkillCard";
import { MySkills } from "@/components/AllTemplates/template2/components/constants/MySkills";
