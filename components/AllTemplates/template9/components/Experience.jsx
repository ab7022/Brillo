                ...
                <React.Fragment key={index}>
                  <div className="flex items-center justify-between w-full my-8">
                    <div className="flex items-center ">
                      <Avatar className="size-10 border bg-gray-300 dark:bg-gray-800 mr-4">
                        <AvatarImage alt={""} src={""} />
                        <AvatarFallback>
                      ...
                      <h1
                        className="experience-text dark:text-white"
                        style={{
                          fontFamily: "PolySans",
                          fontSize: "1.5vw",
                          textAlign: "start",
                  ...
                  <div className=" ml-12 mb-4">
                    {work.description1.length > 0 && (
                      <li>{work.description1}</li>
                    )}
                    {work.description2.length > 0 && (
                      <li>{work.description2}</li>
                    )}
                    {work.description3.length > 0 && (
