...
const config = {
  ...
  plugins: [require("tailwindcss-animate"),require("@tailwindcss/typography"),addVariablesForColors, addSvgPatterns, plugin(function ({ addBase, addComponents, addUtilities }:any) {
    ...
    addComponents({
      ...
      ".h1": {
        "@apply text-[#FAF7F2] font-semibold text-[2.5rem] leading-[3.25rem] md:text-[2.75rem] md:leading-[3.75rem] lg:text-[3.25rem] lg:leading-[4.0625rem] xl:text-[3.75rem] xl:leading-[4.5rem]":
          {},
      },
      ".h2": {
